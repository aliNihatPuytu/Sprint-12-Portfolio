...
export default function ProjectsPage() {
  ...
  return (
    <div className="bg-white text-gray-900 dark:bg-[#0F1020] dark:text-white min-h-screen flex flex-col">
      ...
      <main
        className="flex-grow section-pad flex items-center"
        style={{ backgroundImage: theme === "dark" ? darkGradient : lightGradient }}
      >
        <Projects t={data} />
      </main>

      <footer className="section-flush section-pad minh-contact-454 bg-white dark:bg-[#0F1020] flex items-center">
        <Contact />
      </footer>
    </div>
  );
