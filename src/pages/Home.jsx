...
      <div className="section-flush h-hero-671 text-white"
...
      <div className="section-flush minh-skills-610 bg-white dark:bg-[#141425] flex items-center">
        <Skills t={data} />
      </div>

      <div className="section-flush minh-profile-552 bg-[#4731D3] dark:bg-[#171043] flex items-center">
        <Profile t={data} />
      </div>

      <div className="section-flush minh-projects-1039 flex items-center bg-[rgba(203,242,129,0.40)] dark:bg-[#1A210B]">
        <Projects t={data} />
      </div>

      <div className="section-flush minh-contact-454 bg-white dark:bg-[#0F1020] flex items-center">
        <Contact />
      </div>
    </div>
  );
