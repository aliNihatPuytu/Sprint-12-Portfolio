  ...
  return (
    <section className="w-full">
      <div className="container-outer">
        <h2 className="font-bold mb-6" style={{ fontSize: 48, lineHeight: 1.1, color: "#CBF281" }}>
          {sectionTitle}
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-3 md:gap-[30px] gap-y-10 items-start md:h-[292px]">
          <div className="w-full md:w-[300px] md:h-[292px] overflow-hidden">
            <h3 className="text-white text-2xl font-semibold text-soft-mobile">{basicTitle}</h3>
              ...
              {rows.map((r, i) => (
                <React.Fragment key={i}>
                  <dt className="text-[#CBF281] font-semibold leading-tight">
                    {r.label.map((ln, k) => <span key={k} className="block">{ln}</span>)}
                  </dt>
          ...
          <div className="w-full md:w-[300px] md:h-[292px] profile-mobile-gap">
          ...
          <div className="w-full md:w-[300px] md:h-[292px] overflow-hidden">
            <h3 className="text-white text-2xl font-semibold text-soft-mobile">{aboutTitle}</h3>
            <div className="mt-4 space-y-4 md:max-h-[240px]">
              <p className="text-white/90 text-soft-mobile leading-relaxed text-justify break-words overflow-hidden"
