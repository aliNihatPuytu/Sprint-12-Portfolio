...
  const navLinkColor = "text-[#CBF281] dark:text-[#8F88FF]"; 
...
  return (
    <nav className="pt-6">
      <div className="container-outer grid grid-cols-[1fr_auto_1fr] items-center">
...
            <span className="text-[12px] font-bold text-[#111827] dark:text-white">
              {themeLabel}
            </span>
          </div>
        </div>
